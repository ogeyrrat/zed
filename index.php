...
<html class="loading">
  ...
  <body class="vertical-layout" data-color=".bg-info">   
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong><div class="p-1 mb-2 bg-primary text-white">𝔃𝓮𝓭 𝓬𝓱𝓮𝓬𝓴𝓮𝓻</div></strong></h4>
					
					<textarea rows="4" class="form-control text-center form-checker mb-2" placeholder="【﻿ｄｒｏｐ　ｃｃ　ｈｅｒｅ】"></textarea>
					
	<br>	
<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href=""> 𝔯𝔢𝔩𝔬𝔞𝔡 </a> <br>		
					<button class="btn btn-play btn-glow btn-bg-gradient-x-blue-cyan text-white" style="width: 49%; float: left;"><i class="fa fa-play"></i><p class="text-warning">𝒮𝒯𝒜𝑅𝒯</button>
					<button class="btn btn-stop btn-glow btn-bg-gradient-x-red-pink text-white" style="width: 49%; float: right;" disabled><i class="fa fa-stop"></i><p class="text-primary">S̾T̾O̾P̾</button>
...
<h5><p class="text-success">𝖑𝖎𝖛𝖊 𝖈𝖈𝖓/𝖈𝖈𝖛 :<span class="badge badge-success float-right aprovadas">0</span></h5><hr> 

<h5><p class="text-danger">𝖉𝖊𝖆𝖉 :<span class="badge badge-danger float-right reprovadas">0</span></h5><hr>

<h5><p class="text-info">𝖙𝖔𝖙𝖆𝖑 :<span class="badge badge-primary float-right carregadas">0</span></h5><hr>

<h5>𝖑𝖎𝖒𝖎𝖙 :<span class="badge badge-secondary float-right">9000000</span></h5>
			...
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1"><i class="fa fa-check-circle text-success"></i> <p class="text-success">𝔠𝔥𝔞𝔯𝔤𝔢𝔡</h4>					
		...
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1"><i class="fa fa-check text-success"></i> <p class="text-success">𝔩𝔦𝔳𝔢 𝔠𝔠𝔫/𝔠𝔠𝔳</h4>					
		...
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1"><i class="fa fa-times text-danger"></i><p class="text-danger"> 𝔡𝔢𝔞𝔡</h4>		
